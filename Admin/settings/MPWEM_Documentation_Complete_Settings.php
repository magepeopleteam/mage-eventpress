...
function mep_add_lightbox_styles_and_scripts() {
    ...
    <style>
        ...
        /* Removed order rules for first and last child to allow natural HTML order */
        /*
            ...
            <div class="setting-usage">
                ...
                <ul>
                    ...
                    <li><strong>Hide Expired Events from Calendar:</strong> <?php esc_html_e('Remove past events from calendar display.', 'mage-eventpress'); ?>
                        <div class="setting-screenshots">
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/hide_expired_event_from_calender_backend.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/hide_expired_event_from_calender_backend.png" alt="Hide Expired Calendar Setting - Admin">
                            </a>
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/hide_expired_event_from_calender_frontend.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/hide_expired_event_from_calender_frontend.png" alt="Hide Expired Calendar - Frontend Result">
                            </a>
                        </div>
                    </li>
                    <li><strong>Redirect to Checkout after Booking:</strong> <?php esc_html_e('Auto-redirect to checkout page after adding event to cart.', 'mage-eventpress'); ?>
                        <div class="setting-screenshots">
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/redirect_checkout_after_booking_disable.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/redirect_checkout_after_booking_disable.png" alt="Redirect Checkout Setting - Admin">
                            </a>
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/redirect_checkout_after_booking_enable.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/redirect_checkout_after_booking_enable.png" alt="Redirect Checkout - Frontend Flow">
                            </a>
                        </div>
                    </li>
                    <li><strong>Show 0 Price as Free:</strong> <?php esc_html_e('Display "Free" instead of "$0" for no-cost events.', 'mage-eventpress'); ?>
                    <div class="setting-screenshots">
    <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Price_as_Free_backend.png" class="mep-lightbox">
        <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Price_as_Free_backend.png" alt="Show Free Price Setting - Admin">
    </a>
    <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Price_as_Free_frontend.png" class="mep-lightbox">
        <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Price_as_Free_frontend.png" alt="Show Free Price - Frontend Display 1">
    </a>
    <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Price_as_Free_frontend-2.png" class="mep-lightbox">
        <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Price_as_Free_frontend-2.png" alt="Show Free Price - Frontend Display 2">
    </a>
</div>
                    </li>
                    <li><strong>Ticket Expire Before Minutes:</strong> <?php esc_html_e('Stop ticket sales X minutes before event starts.', 'mage-eventpress'); ?>
                        <div class="setting-screenshots">
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Ticket_Expire_Before_Minutes_backend.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Ticket_Expire_Before_Minutes_backend.png" alt="Ticket Expire Minutes Setting - Admin">
                            </a>
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Ticket_Expire_Before_Minutes_frontend.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Ticket_Expire_Before_Minutes_frontend.png" alt="Ticket Expire Minutes - Frontend Effect">
                            </a>
                        </div>
                    </li>
                    ...
                    <li><strong>Hide Fully Booked Events:</strong> <?php esc_html_e('Remove sold-out events from event listings.', 'mage-eventpress'); ?>
                        <div class="setting-screenshots">
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Sold_out_Ribon_backend.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Sold_out_Ribon_backend.png" alt="Hide Fully Booked Setting - Admin">
                            </a>
                            <a href="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Sold_out_Ribon_frontend.png" class="mep-lightbox">
                                <img src="https://raw.githubusercontent.com/magepeopleteam/mageresource/main/Event/Show_Sold_out_Ribon_frontend.png" alt="Hide Fully Booked - Frontend Result">
                            </a>
                        </div>
                    </li>
