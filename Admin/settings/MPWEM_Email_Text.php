	...
	if ( ! class_exists( 'MPWEM_Email_Text' ) ) {
		class MPWEM_Email_Text {
			public function __construct() {
				...
				add_action( 'wp_ajax_nopriv_mep_email_text_save', array( $this, 'email_text_save' ) );
			}
			...
			public function email_text_tab_content( $post_id ) {
                ...
                <div class="mp_tab_item" data-tab-item="#mp_event_email_text">
                    <h3><?php esc_html_e( 'Email Text settings', 'mage-eventpress' ); ?></h3>
                        ...
                        <div class="mep-modal-content">
                            ...
                            <div class="content">
                                ...
                                <div class="mep_email_text_save_buttons">
                                    <p>
                                        <button id="mep_email_text_save" class="button button-primary button-large"><?php _e( 'Save', 'mage-eventpress' ); ?></button>
                                        <button id="mep_email_text_save_close" class="button button-primary button-large">save close</button>
                                    <p>
                                </div>
                                <div class="mep_email_text_update_buttons" style="display: none;">
                                    <p>
                                        <button id="mep_email_text_update" class="button button-primary button-large"><?php _e( 'Update and Close', 'mage-eventpress' ); ?></button>
                                    <p>
                                </div>
                            </div>
                        </div>
