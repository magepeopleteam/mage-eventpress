        ...
        public function template_override_settings_page() {
            ...
            <div class="mpwem-template-override-wrapper">
                ...
                <div class="mpwem-template-override-notice">
                    ...
                    <ul>
                        <li><?php esc_html_e('Templates will be copied to: ', 'mage-eventpress'); ?><code><?php echo get_stylesheet_directory(); ?>/mage-events/</code></li>
            ...
            <style>
            .mpwem-template-override-wrapper {
                max-width: 1200px;
                margin: 20px 0;
            }
            .mpwem-template-override-notice {
                background: #fff3cd;
            ...
            .mpwem-template-item.overridden {
                border-color: #28a745;
                background: #d4edda;
            }
            .mpwem-template-name {
            ...
            .mpwem-template-status {
                margin-bottom: 10px;
            }
            .mpwem-template-actions {
                display: flex;
                gap: 10px;
            }
            .mpwem-btn {
            ...
            .mpwem-status-overridden {
                background: #28a745;
                color: white;
            }
            .mpwem-status-default {
                background: #6c757d;
                color: white;
            }
            .mpwem-loading {
                ...
                $(document).on('click', '.mpwem-copy-template', function(e) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            nonce: '<?php echo wp_create_nonce('mep_template_override_nonce'); ?>'
                        },
                    ...
                    ?>
                        <div class="mpwem-template-item <?php echo $is_overridden ? 'overridden' : ''; ?>">
                            ...
                            <div class="mpwem-template-actions">
                                ...
                                <a href="<?php echo admin_url('theme-editor.php?file=mage-events/' . str_replace('templates/', '', $template_path) . '&theme=' . get_stylesheet()); ?>" 
