<?php
   ...
   */
	...
	if (!class_exists('MPWEM_Select_Icon_image')) {
		$GLOBALS['mpwem_icon_popup_exit'] = false;
		class MPWEM_Select_Icon_image {
			public function __construct() {
				add_action('mpwem_input_add_icon', array($this, 'load_icon'), 10, 2);
				add_action('mpwem_add_single_image', array($this, 'add_single_image'), 10, 2);
			...
			public function add_single_image($name, $image_id = '') {
				?>
				<div class="mpwem_add_single_image">
