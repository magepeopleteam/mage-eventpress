                ...
                <div class="mp_event_all_meta_in_tab mp_event_tab_area">
                    <div class="mp_tab_menu">
                        <ul>
                            ...
                            <li data-target-tabs="#mp_ticket_type_pricing"><i class="mi mi-coins"></i><?php esc_html_e( 'Ticket & Pricing', 'mage-eventpress' ); ?> </li>
							<?php do_action( 'mep_admin_event_details_before_tab_name_ticket_type', $post_id ); ?>
                            <li data-target-tabs="#mp_event_time"><i class="mi mi-calendar-clock"></i><?php esc_html_e( 'Date & Time', 'mage-eventpress' ); ?> </li>
