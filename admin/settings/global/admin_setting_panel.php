				...
				$settings_fields = array(
					...
					'icon_setting_sec'         => apply_filters( 'mep_settings_icon_arr', array(
							...
							array(
								...
								'desc'        => __( 'Custom Facebook share URL. Use {url}, {title} and {excerpt} placeholders. Leave empty to use the default. Example: https://www.facebook.com/sharer.php?u={url}', 'mage-eventpress' ),
								'type'        => 'text',
								'placeholder' => 'https://www.facebook.com/sharer.php?u={url}',
								'default'     => '',
							),
							array(
								'name'        => 'mep_event_ss_twitter_url',
								'label'       => __( 'Twitter Share URL', 'mage-eventpress' ),
								'desc'        => __( 'Custom Twitter share URL. Use {url}, {title} and {excerpt} placeholders. Leave empty to use the default. Example: https://twitter.com/share?url={url}&text={title}', 'mage-eventpress' ),
								'type'        => 'text',
								'placeholder' => 'https://twitter.com/share?url={url}&text={title}',
								'default'     => '',
							),
							array(
								'name'        => 'mep_event_ss_linkedin_url',
								'label'       => __( 'LinkedIn Share URL', 'mage-eventpress' ),
								'desc'        => __( 'Custom LinkedIn share URL. Use {url}, {title} and {excerpt} placeholders. Leave empty to use the default. Example: https://www.linkedin.com/shareArticle?mini=true&url={url}&title={title}&summary={excerpt}&source=web', 'mage-eventpress' ),
								'type'        => 'text',
								'placeholder' => 'https://www.linkedin.com/shareArticle?mini=true&url={url}&title={title}&summary={excerpt}&source=web',
								'default'     => '',
							),
							array(
								'name'        => 'mep_event_ss_whatsapp_url',
								'label'       => __( 'WhatsApp Share URL', 'mage-eventpress' ),
								'desc'        => __( 'Custom WhatsApp share URL. Use {url}, {title} and {excerpt} placeholders. Leave empty to use the default. Example: https://api.whatsapp.com/send?text={title} {url}', 'mage-eventpress' ),
								'type'        => 'text',
								'placeholder' => 'https://api.whatsapp.com/send?text={title} {url}',
								'default'     => '',
							),
							array(
								'name'        => 'mep_event_ss_email_url',
								'label'       => __( 'Email Share URL', 'mage-eventpress' ),
								'desc'        => __( 'Custom email share URL (mailto:). Use {url}, {title} and {excerpt} placeholders. Leave empty to use the default. Example: mailto:?subject=I wanted you to see this site&body={title} {url}', 'mage-eventpress' ),
								'type'        => 'text',
								'placeholder' => 'mailto:?subject=I wanted you to see this site&body={title} {url}',
								'default'     => '',
							),
						)
					),
