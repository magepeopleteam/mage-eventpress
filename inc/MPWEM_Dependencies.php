	...
	if (!class_exists('MPWEM_Dependencies')) {
		class MPWEM_Dependencies {
			...
			public function add_inline_styles(){
				...
				$datepicker_bg_color = mep_get_option('mep_re_datepicker_bg_color', 'style_setting_sec', '#ffbe30');
				$datepicker_text_color = mep_get_option('mep_re_datepicker_text_color', 'style_setting_sec', '#fff');
				$inline_css = "
					:root{
						--mpev-primary:{$base_color};
						--mpev-primary-alter:{$base_text_color};
						--mpev-secondary:{$calender_btn_bg_color};
						--mpev-primary-alter:{$calender_btn_txt_color};
						--mpev-tertiary:{$faq_label_bg_color};
						--mpev-tertiary-alter:{$faq_label_text_color};
						--mpev-dark:#303030;
						--mpev-gray:#d3d3d3;
						--mpev-light:#f2f2f2;
						--mpev-green:#32c1a4;
					...
					.mep-event-faq-part .ex-sec-title.faq-title-section{
						background: {$faq_label_bg_color};
						color: {$faq_label_text_color};
					}
					...
					div.item_hover_effect a:hover{
						color:{$base_color};background-color:#fff;border:1px solid {$base_color};
					}
					...
					.mpwemasp_ticket_area .mep_everyday_date_secs{ background: {$label_bg_color}; color: {$label_text_color}; }
					/*FAQ Sec Style*/
					...
					.mep-default-feature-cart-sec button.single_add_to_cart_button.button.alt.btn-mep-event-cart, .mep-event-theme-1 .btn-mep-event-cart, .mep-template-2-hamza .btn-mep-event-cart, .mep-tem3-mid-sec .btn-mep-event-cart, .button.button-default.woocommerce.button.alt.button.alt.btn-mep-event-cart {
						background: {$cart_btn_bg_color};
						color: {$cart_btn_txt_color} !important;
						border-color: {$cart_btn_bg_color};
					}

					/*Calender Button Style*/
					.mep-default-sidrbar-calender-btn a, .mep-event-theme-1 .mep-add-calender, .mep-template-2-hamza .mep-add-calender, .mep-tem3-mid-sec .mep-add-calender, #mep_add_calender_button, .royal_theme #mep_add_calender_button, .royal_theme ul#mep_add_calender_links li a {
						background: {$calender_btn_bg_color};
						color: {$calender_btn_txt_color} !important;
						border-color: {$calender_btn_bg_color};
					}
					...
					.royal_theme .mep-default-feature-content{
						background: {$royal_primary_bg_color};
					}
					.royal_theme .mep-default-col-1,
					.royal_theme .mep-default-col-2{
						background-color: {$royal_secondary_bg_color};
					}
					...
					.royal_theme .mep-default-sidrbar-events-schedule h3 i{
						background-color: {$royal_icons_bg_color};
					}
					.royal_theme .mep-default-title,
					.royal_theme div.df-dtl h3,
					.royal_theme .mep-default-col-2,
					.mep-events-wrapper .royal_theme table td{
						border-color: {$royal_border_color};
					}
					...
					.royal_theme .mep-default-sidrbar-price-seat h5{
						color: {$royal_text_color};
					}
					.mep_everyday_date_secs {
						background: {$datepicker_bg_color};
						color: {$datepicker_text_color};
						padding: 10px;
					}
				";
