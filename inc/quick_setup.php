...
foreach ($mep_settings_tab as $page_key => $tab)
    $tabs_sorted[$page_key] = isset($tab['priority']) ? $tab['priority'] : 0;
            ...
            <div class="welcome-tabs">
                ...
                <ul class="tab-navs">
                    ...
                    foreach ($mep_settings_tab as $tab) {
                        ...
                        ?>
                        <li <?php if (!empty($data_visible)): ?> data_visible="<?php echo esc_html($data_visible); ?>" <?php endif; ?> class="tab-nav <?php if ($hidden)
                            echo 'hidden'; ?> <?php if ($active)
                            echo 'active'; ?>" data-id="<?php echo esc_html($id); ?>"><?php echo $title; ?></li>
                        <?php
                    }
                    ?>
                </ul>
                ...
                foreach ($mep_settings_tab as $tab) {
                    ...
                    <div class="tab-content <?php if ($active)
                        echo 'active'; ?>" id="<?php echo esc_html($id); ?>">
