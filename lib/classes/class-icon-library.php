    ...
    class mep_icon_library {
        public function mep_fontawesome_icons() {
            ...
            return array (
                ...
                'flaticon-drop' => 'drop',
                'flaticon-christmas-tree' => 'christmas-tree',
                'flaticon-plus' => 'plus',
                'flaticon-rocket-ship' => 'rocket-ship',
                'flaticon-battery' => 'battery',
                'flaticon-target' => 'target',
                'flaticon-classroom' => 'classroom',
                'flaticon-first-aid-kit' => 'first-aid-kit',
                'flaticon-tablet' => 'tablet',
                'flaticon-dustbin' => 'dustbin',
                'flaticon-telegram-logo' => 'telegram-logo',
                'flaticon-business' => 'business',
                'flaticon-4-square-shapes' => '4-square-shapes',
                'flaticon-speech-bubble-and-three-dots' => 'speech-bubble-and-three-dots',
                'flaticon-man' => 'man',
                'flaticon-music' => 'music',
                'flaticon-tree-of-love' => 'tree-of-love',
                'flaticon-play-button' => 'play-button',
                'flaticon-long-arrow-pointing-to-the-right' => 'long-arrow-pointing-to-the-right',
                'flaticon-royal-crown-of-elegant-vintage-design' => 'royal-crown-of-elegant-vintage-design',
                'flaticon-desktop-computer-with-magnifying-lens-focusing-on-data' => 'desktop-computer-with-magnifying-lens-focusing-on-data',
                'flaticon-test-tube-flask-and-drop-of-blood' => 'test-tube-flask-and-drop-of-blood',
                'flaticon-arrows' => 'arrows',
                'flaticon-stocks-graphic-on-laptop-monitor' => 'stocks-graphic-on-laptop-monitor',
                'flaticon-attachment' => 'attachment',
                'flaticon-transport' => 'transport',
                'flaticon-recycle-triangle-of-three-arrows-outlines' => 'recycle-triangle-of-three-arrows-outlines',
                'flaticon-arrows-1' => 'arrows-1',
                'flaticon-snowflake' => 'snowflake',
                'flaticon-clock' => 'clock',
                'flaticon-find-in-folder' => 'find-in-folder',
                'flaticon-smartphone' => 'smartphone',
                'flaticon-arrow-pointing-to-right' => 'arrow-pointing-to-right',
                'flaticon-gas-pump' => 'gas-pump',
                'flaticon-house-silhouette' => 'house-silhouette',
                'flaticon-cancel-music' => 'cancel-music',
                'flaticon-arrows-2' => 'arrows-2',
                'flaticon-floor' => 'floor',
                'flaticon-exercise' => 'exercise',
                'flaticon-love-planet' => 'love-planet',
                'flaticon-workers' => 'workers',
                'flaticon-open-magazine' => 'open-magazine',
                'flaticon-confirm-schedule' => 'confirm-schedule',
                'flaticon-star' => 'star',
                'flaticon-order' => 'order',
                'flaticon-key' => 'key',
                'flaticon-medical' => 'medical',
                'flaticon-bank' => 'bank',
                'flaticon-smartphone-1' => 'smartphone-1',
                'flaticon-plug' => 'plug',
                'flaticon-arrows-3' => 'arrows-3',
                'flaticon-arrows-4' => 'arrows-4',
                'flaticon-money-bag' => 'money-bag',
                'flaticon-next' => 'next',
                'flaticon-back' => 'back',
                'flaticon-reload' => 'reload',
                'flaticon-headphones' => 'headphones',
                'flaticon-signs' => 'signs',
                'flaticon-diamond' => 'diamond',
                'flaticon-chat' => 'chat',
                'flaticon-phone' => 'phone',
                'flaticon-down-chevron' => 'down-chevron',
                'flaticon-up-chevron' => 'up-chevron',
                'flaticon-stairs' => 'stairs',
                'flaticon-music-player' => 'music-player',
                ...
                'flaticon-bar-chart' => 'bar-chart',
                'flaticon-handshake' => 'handshake',
                'flaticon-time' => 'time',
                'flaticon-worldwide' => 'worldwide',
                'flaticon-board' => 'board',
                'flaticon-twitter' => 'twitter',
                'flaticon-smartphone-2' => 'smartphone-2',
                'flaticon-mobile' => 'mobile',
                'flaticon-maps-and-flags' => 'maps-and-flags',
                'flaticon-add' => 'add',
                'flaticon-substract' => 'substract',
                'flaticon-phone-call' => 'phone-call',
                'flaticon-mail' => 'mail',
                'flaticon-folder' => 'folder',
                'flaticon-shopping-cart' => 'shopping-cart',
                'flaticon-monitor' => 'monitor',
                'flaticon-menu-1' => 'menu-1',
                'flaticon-cancel' => 'cancel',
                'flaticon-up-arrow-inside-circle' => 'up-arrow-inside-circle',
                'flaticon-circular-down-arrow-button' => 'circular-down-arrow-button',
                'flaticon-24-hours' => '24-hours',
                'flaticon-t-shirt-outline' => 't-shirt-outline',
                'flaticon-folder-outline' => 'folder-outline',
                'flaticon-quote' => 'quote',
                'flaticon-play-button-2' => 'play-button-2',
                'flaticon-right-quotation-sign' => 'right-quotation-sign',
                'flaticon-up-arrow' => 'up-arrow',
                'flaticon-open-mail-interface-symbol' => 'open-mail-interface-symbol',
                'flaticon-menu-button' => 'menu-button',
                'flaticon-smartphone-3' => 'smartphone-3',
                'flaticon-add-1' => 'add-1',
                'flaticon-play-button-3' => 'play-button-3',
                'flaticon-play-button-4' => 'play-button-4',
                'flaticon-support' => 'support',
                'flaticon-close' => 'close',
                'flaticon-heart' => 'heart',
                'flaticon-renewable' => 'renewable',
                'flaticon-shopping-cart-1' => 'shopping-cart-1',
                'flaticon-bar-chart-1' => 'bar-chart-1',
                'flaticon-profit' => 'profit',
                'flaticon-settings-1' => 'settings-1',
                'flaticon-tick-inside-a-circle' => 'tick-inside-a-circle',
                'flaticon-confirm' => 'confirm',
                'flaticon-edit-1' => 'edit-1',
                'flaticon-share-1' => 'share-1',
                'flaticon-setting' => 'setting',
                'flaticon-stars' => 'stars',
                'flaticon-check' => 'check',
                'flaticon-moon' => 'moon',
                'flaticon-star-2' => 'star-2',
                'flaticon-decreasing' => 'decreasing',
                'flaticon-graph' => 'graph',
                'flaticon-multi-tab' => 'multi-tab',
                'flaticon-graph-1' => 'graph-1',
                'flaticon-graph-2' => 'graph-2',
                'flaticon-tick' => 'tick',
                'flaticon-pin' => 'pin',
                'flaticon-small-calendar' => 'small-calendar',
                'flaticon-alarm-clock' => 'alarm-clock',
                'flaticon-shopping-cart-2' => 'shopping-cart-2',
                'flaticon-close-1' => 'close-1',
                'flaticon-settings-2' => 'settings-2',
                'flaticon-telephone' => 'telephone',
                'flaticon-clock-2' => 'clock-2',
                'flaticon-home-1' => 'home-1',
                'flaticon-search-1' => 'search-1',
                'flaticon-abc-block' => 'abc-block',
                'flaticon-notification' => 'notification',
                'flaticon-attachment-1' => 'attachment-1',
                'flaticon-down-arrow' => 'down-arrow',
                'flaticon-phone-receiver' => 'phone-receiver',
                'flaticon-next-1' => 'next-1',
                'flaticon-back-1' => 'back-1',
                'flaticon-phone-call-1' => 'phone-call-1',
                'flaticon-left-arrow-inside-a-circle' => 'left-arrow-inside-a-circle',
                'flaticon-right-arrow-inside-a-circle' => 'right-arrow-inside-a-circle',
                'flaticon-search-2' => 'search-2',
                'flaticon-karaoke' => 'karaoke',
                'flaticon-partnership' => 'partnership',
                'flaticon-solution' => 'solution',
                'flaticon-group' => 'group',
                'flaticon-group-1' => 'group-1',
                'flaticon-team' => 'team',
                'flaticon-key-1' => 'key-1',
                'flaticon-diamond-1' => 'diamond-1',
                'flaticon-fish' => 'fish',
                'flaticon-fish-1' => 'fish-1',
                'flaticon-connection' => 'connection',
                'flaticon-server' => 'server',
                'flaticon-cloud' => 'cloud',
                'flaticon-coffee' => 'coffee',
                'flaticon-gift' => 'gift',
                'flaticon-wife' => 'wife',
                'flaticon-team-1' => 'team-1',
                'flaticon-team-2' => 'team-2',
                'flaticon-team-3' => 'team-3',
                'flaticon-employee' => 'employee',
                'flaticon-group-2' => 'group-2',
                'flaticon-movie-tickets' => 'movie-tickets',
                'flaticon-lecture' => 'lecture',
                'flaticon-employee-1' => 'employee-1',                
            );
        }
