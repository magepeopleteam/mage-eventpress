<?php
	...
	*/
	...
	$location_icon             = array_key_exists( 'mep_event_location_icon', $icon_setting_sec ) ? $icon_setting_sec['mep_event_location_icon'] : 'mi mi-map-marker';
	$location_icon             = $location_icon === 'mi mi-marker' ? 'mi mi-map-marker' : $location_icon;
