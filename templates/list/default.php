...
*/
	...
	$width                          = is_array($event_infos) && array_key_exists( 'width', $event_infos ) ? $event_infos['width'] : '';
	$column_number                  = is_array($event_infos) && array_key_exists( 'column_number', $event_infos ) ? $event_infos['column_number'] : '';
	$class_name                     = is_array($event_infos) && array_key_exists( 'class_name', $event_infos ) ? $event_infos['class_name'] : '';
	$style                          = is_array($event_infos) && array_key_exists( 'style', $event_infos ) ? $event_infos['style'] : '';
