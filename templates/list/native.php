...
>
	...
	<div class="mep_event_native_list__surface">
		<a class="mep_event_native_list__media" href="<?php echo esc_url( $permalink ); ?>" aria-label="<?php echo esc_attr( $title ); ?>">
			<?php do_action( 'mpwem_list_thumb', $event_infos ); ?>
			<?php if ( $date_day ) : ?>
				<span class="mep_event_native_list__date" aria-hidden="true">
					<span class="mep_event_native_list__month"><?php echo esc_html( $date_month ); ?></span>
					<span class="mep_event_native_list__day"><?php echo esc_html( $date_day ); ?></span>
				</span>
			<?php endif; ?>
		...
		<div class="mep_list_event_details mep_event_native_list__body">
			<a class="mep_event_native_list__link" href="<?php echo esc_url( $permalink ); ?>">
			...
			<div class="mep_event_native_list__footer">
