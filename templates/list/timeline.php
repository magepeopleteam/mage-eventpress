...
<div class="timeline__item mep-event-list-loop"
    ...
    <div class="timeline__content">
        <div class="mep_event_timeline_list">
            ...
            <div class="mep_event_timeline_list__media">
            ...
            <div class="mep_list_event_details mep_event_timeline_list__body">
                <a class="mep_event_timeline_list__link" href="<?php echo esc_url( $permalink ); ?>">
                ...
                <div class="mep_event_timeline_list__footer">
