...
<div id="mep_add_calender_button" class='mep-add-calender'>
    <i class="<?php echo esc_attr($event_date_icon); ?>"></i><?php echo esc_html(mep_get_label($pid,'mep_calender_btn_text',esc_html__('Add Calendar','mage-eventpress'))); ?>
</div>  
