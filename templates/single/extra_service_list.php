<div id='mep_event_extra_service_table' class="mep-event-ticket-type">
    <div class="mep-event-ticket-type-header"><?php echo esc_html($extra_service_label); ?></div>
    ...
    ?>
        <div class="mep-event-ticket-item">
            <div class="ticket-info">
                <div class="ticket-name"><?php echo esc_html($service_name); ?> <span class="badge">Basic</span></div>
                ...
                <div class="ticket-remaining remaining-high">
                    <?php if ($mep_available_seat == 'on') { ?>
                        <div class="xtra-item-left"><?php echo esc_html($ext_left); ?>
                            <?php echo mep_get_option('mep_left_text', 'label_setting_sec', __('Remaining', 'mage-eventpress'));  ?>
                        </div>
                    <?php } ?>
                ...
                <?php
                    if ($ext_left > 0) {
                        ...
                        <?php } else { ?>
                            ...
                            <input id="eventpx" size="4" inputmode="numeric" type="text" class='extra-qty-box qty-input' name='event_extra_service_qty[]' data-price='<?php echo esc_attr($data_price); ?>' value='0' min="0" max="<?php echo esc_attr($ext_left); ?>">
            ...
            <div class="ticket-price">
                <?php echo wc_price(esc_html(mep_get_price_including_tax($post_id, $service_price)));
                if ($ext_left > 0) { ?>
